...
randomly samples one sibling per nest from the \# offspring survival dataset
...
run stochastic demographic simulation UP TO HERE 20.11.2023
### TESTING
```{r}
...
#     # Define coucal life-stages of the coucal matrix model
#       stages <- c("F_1st_year",  "F_Adult",  "M_1st_year",  "M_Adult")
#       demographic_rates_ = demographic_rates
#       # Build the 4x4 matrix
#       demographic_matrix <- 
#         matrix(c(
#           
...
WBC_hazard_ASR_bootstrap_result_w_WBC_ad_surv_stoc <-
  pbsapply(1:niter, run_bootstrap_juv_hazd_ad_surv_ASR,
           offspring = status_dat_all %>% filter(species == "WBC"), # BC_all_dat,
...
saveRDS(object = BC_hazard_ASR_bootstrap_result_w_trans_WBC_ad_surv_stoc, 
        file = "tmp/BC_hazard_ASR_bootstrap_result_w_trans_WBC_ad_surv_stoc.rds") # DEMO "output/bootstraps/hazard/cooked/BC_hazard_ASR_bootstrap_result_w_trans_WBC_ad_surv_stoc_no_imm.rds"

saveRDS(object = WBC_hazard_ASR_bootstrap_result_w_WBC_ad_surv_stoc, 
        file = "tmp/WBC_hazard_ASR_bootstrap_result_w_WBC_ad_surv_stoc.rds") # DEMO "output/bootstraps/hazard/cooked/WBC_hazard_ASR_bootstrap_result_w_WBC_ad_surv_stoc_no_imm.rds"
```
...
BC_hazard_rate_boot_tidy_trans_no_imm <- 
  hazard_boot_out_wrangle(species = "BC", niter = 1000, 
                          output_dir = "tmp/", #"output/bootstraps/hazard/cooked/",
                          rds_file = 
                           "_hazard_ASR_bootstrap_result_w_trans_WBC_ad_surv_stoc")# "_hazard_ASR_bootstrap_result_w_trans_WBC_ad_surv_stoc_no_imm")
...
saveRDS(object = BC_hazard_rate_boot_tidy_trans_no_imm, 
        file = 
          "tmp/BC_haz_sur_ASR_boot_tidy_stoc_trans_no_imm.rds") #"output/bootstraps/hazard/cooked/BC_haz_sur_ASR_boot_tidy_stoc_trans_no_imm.rds")

saveRDS(object = WBC_hazard_rate_boot_tidy_no_imm, 
        file = 
          "tmp/WBC_haz_sur_ASR_boot_tidy_stoc_no_imm.rds") #"output/bootstraps/hazard/cooked/WBC_haz_sur_ASR_boot_tidy_stoc_no_imm.rds")
```
...
BC_hazard_rate_boot_tidy <-
  readRDS("tmp/BC_haz_sur_ASR_boot_tidy_stoc_trans_no_imm.rds") #"output/bootstraps/hazard/cooked/BC_haz_sur_ASR_boot_tidy_stoc_trans_no_imm.rds")

# load output
WBC_hazard_rate_boot_tidy <-
  readRDS("tmp/WBC_haz_sur_ASR_boot_tidy_stoc_no_imm.rds") #"output/bootstraps/hazard/cooked/WBC_haz_sur_ASR_boot_tidy_stoc_no_imm.rds")
...
# load output
BC_hazard_rate_boot_tidy <-
  readRDS("tmp/BC_haz_sur_ASR_boot_tidy_stoc_trans_no_imm.rds") # "/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/bootstraps/hazard/cooked/BC_haz_sur_ASR_boot_tidy_stoc_trans_no_imm.rds")

# load output
WBC_hazard_rate_boot_tidy <-
  readRDS("tmp/WBC_haz_sur_ASR_boot_tidy_stoc_no_imm.rds") # "/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/bootstraps/hazard/cooked/WBC_haz_sur_ASR_boot_tidy_stoc_no_imm.rds")
    ...
    for (g in 1:n) { # pick a column (i.e., a variable) 
      ...
      for (i in 1:length(vr_nums)) # pick a perturbation level
      {
        ...
        for (j in 1:niter) { # project the matrix through t iteration
          ...
          M2 <- stage[4, j] * A["M_Adult", "M_Adult"] #+ I[4, 1]
          
          # number of female adults at time t
          F2 <- stage[2, j] * A["F_Adult", "F_Adult"] #+ I[2, 1]
...
make_mprime_matrix <- 
  function(survival_rates_boot_summary, 
    ...
    if(sex == "male"){
      list(F_Nestling_survival = (filter(survival_rates_boot_summary,
                                         species == species_name & vital_rate == "Female_nestling_survival")[, 4] +#)[7, 4] + 
                                    filter(survival_rates_boot_summary,
                                           species == species_name & vital_rate == "Male_nestling_survival")[, 4]) / 2,
           F_Groundling_survival = (filter(survival_rates_boot_summary,
                                         species == species_name & vital_rate == "Female_groundling_survival")[, 4] +#)[7, 4] + 
                                    filter(survival_rates_boot_summary,
                                           species == species_name & vital_rate == "Male_groundling_survival")[, 4]) / 2,
           F_Fledgling_survival = (filter(survival_rates_boot_summary,
                                         species == species_name & vital_rate == "Female_fledgling_survival")[, 4] +#)[7, 4] + 
                                    filter(survival_rates_boot_summary,
                                           species == species_name & vital_rate == "Male_fledgling_survival")[, 4]) / 2,
           F_Adult_survival = (filter(survival_rates_boot_summary,
                                         species == species_name & vital_rate == "Female_adult_survival")[, 4] +#)[7, 4] + 
                                    filter(survival_rates_boot_summary,
                                           species == species_name & vital_rate == "Male_adult_survival")[, 4]) / 2,
           M_Nestling_survival = (filter(survival_rates_boot_summary,
                                         species == species_name & vital_rate == "Male_nestling_survival")[, 4] +#)[7, 4] + 
                                    filter(survival_rates_boot_summary,
                                           species == species_name & vital_rate == "Male_nestling_survival")[, 4]) / 2,
           M_Groundling_survival = (filter(survival_rates_boot_summary,
                                         species == species_name & vital_rate == "Male_groundling_survival")[, 4] +#)[7, 4] + 
                                    filter(survival_rates_boot_summary,
                                           species == species_name & vital_rate == "Male_groundling_survival")[, 4]) / 2,
           M_Fledgling_survival = (filter(survival_rates_boot_summary,
                                         species == species_name & vital_rate == "Male_fledgling_survival")[, 4] +#)[7, 4] + 
                                    filter(survival_rates_boot_summary,
                                           species == species_name & vital_rate == "Male_fledgling_survival")[, 4]) / 2,
           M_Adult_survival = (filter(survival_rates_boot_summary,
                                         species == species_name & vital_rate == "Male_adult_survival")[, 4] +#)[7, 4] + 
                                    filter(survival_rates_boot_summary,
                                           species == species_name & vital_rate == "Male_adult_survival")[, 4]) / 2,
           Egg_survival = filter(survival_rates_boot_summary,
...
saveRDS(object = BC_treat_sensitivity_analysis, 
        file = "/tmp/BC_treat_sensitivity_analysis_ASR_no_imm_trans.rds") # "/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/sensitivity_analysis/BC_treat_sensitivity_analysis_ASR_no_imm_trans.rds")

saveRDS(object = BC_Mprime_sensitivity_analysis_male, 
        file = "/tmp/BC_Mprime_sensitivity_analysis_male_ASR_no_imm_trans.rds") #"/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/sensitivity_analysis/BC_Mprime_sensitivity_analysis_male_ASR_no_imm_trans.rds")

saveRDS(object = BC_Mprime_sensitivity_analysis_female, 
        file = "/tmp/BC_Mprime_sensitivity_analysis_female_ASR_no_imm_trans.rds") #"/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/sensitivity_analysis/BC_Mprime_sensitivity_analysis_female_ASR_no_imm_trans.rds")

saveRDS(object = WBC_treat_sensitivity_analysis, 
        file = "/tmp/WBC_treat_sensitivity_analysis_ASR_no_imm.rds") #"/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/sensitivity_analysis/WBC_treat_sensitivity_analysis_ASR_no_imm.rds")

saveRDS(object = WBC_Mprime_sensitivity_analysis_male, 
        file = "/tmp/WBC_Mprime_sensitivity_analysis_male_ASR_no_imm.rds") #"/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/sensitivity_analysis/WBC_Mprime_sensitivity_analysis_male_ASR_no_imm.rds")

saveRDS(object = WBC_Mprime_sensitivity_analysis_female, 
        file = "/tmp/WBC_Mprime_sensitivity_analysis_female_ASR_no_imm.rds") #"/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/sensitivity_analysis/WBC_Mprime_sensitivity_analysis_female_ASR_no_imm.rds")

BC_treat_sensitivity_analysis <-
  readRDS(file = "/Users/leberhart/ownCloud - luke.eberhart@orn.mpg.de@owncloud.gwdg.de (2)/coucal_ASR/R_project/output/sensitivity_analysis/BC_treat_sensitivity_analysis_ASR.rds")

BC_Mprime_sensitivity_analysis_male <-
  readRDS(file = "/Users/leberhart/ownCloud - luke.eberhart@orn.mpg.de@owncloud.gwdg.de (2)/coucal_ASR/R_project/output/sensitivity_analysis/BC_Mprime_sensitivity_analysis_male_ASR.rds")

BC_Mprime_sensitivity_analysis_female <-
  readRDS(file = "/Users/leberhart/ownCloud - luke.eberhart@orn.mpg.de@owncloud.gwdg.de (2)/coucal_ASR/R_project/output/sensitivity_analysis/BC_Mprime_sensitivity_analysis_female_ASR.rds")

WBC_treat_sensitivity_analysis <-
  readRDS(file = "/Users/leberhart/ownCloud - luke.eberhart@orn.mpg.de@owncloud.gwdg.de (2)/coucal_ASR/R_project/output/sensitivity_analysis/WBC_treat_sensitivity_analysis_ASR.rds")

WBC_Mprime_sensitivity_analysis_male <-
  readRDS(file = "/Users/leberhart/ownCloud - luke.eberhart@orn.mpg.de@owncloud.gwdg.de (2)/coucal_ASR/R_project/output/sensitivity_analysis/WBC_Mprime_sensitivity_analysis_male_ASR.rds")

WBC_Mprime_sensitivity_analysis_female <-
  readRDS(file = "/Users/leberhart/ownCloud - luke.eberhart@orn.mpg.de@owncloud.gwdg.de (2)/coucal_ASR/R_project/output/sensitivity_analysis/WBC_Mprime_sensitivity_analysis_female_ASR.rds")
