...
```{r}
knitr::opts_knit$set(root.dir = "/Users/luketheduke2/ownCloud/coucal_ASR/R_project/")
```
...
WBC_adult_survival_CJS_bootstrap_tidy <- 
  surv_boot_out_wrangle(species = "WBC", niter = 10000)

saveRDS(WBC_adult_survival_CJS_bootstrap_tidy,
        file = "output/wrangled/WBC_adult_survival_CJS_bootstrap_tidy.rds")
```
...
mating_dat <- 
  # read raw data
  read.csv("/Users/luketheduke2/ownCloud/coucal_ASR/R_project/data/raw/Coucal_Nr_mates_2001_2019_20200123.csv", 
           header = TRUE, stringsAsFactors = FALSE, na.strings = c("", " ", "NA")) %>% 
  # str()
...
egg_data <-
  read_xls("/Users/luketheduke2/ownCloud/coucal_ASR/R_project/data/raw/Egg_surv_data_2001_2019_20210524.xls", na = "NA", col_types = "text") %>% 
...
# import raw csv data into R
egg_data <-
  read_xls("/Users/luketheduke2/ownCloud/coucal_ASR/R_project/data/raw/Egg_surv_data_2001_2019_20210524.xls", 
...
```{r}
fledge_dat <- 
  read.csv("/Users/luketheduke2/ownCloud/coucal_ASR/R_project/data/raw/Coucal_chick_survival_2001-2019_20200129.csv", 
           header = TRUE, stringsAsFactors = FALSE, na.strings = c("", " ", "NA")) %>%
...
```{r}
flight_dat <- 
  read.csv("/Users/luketheduke2/ownCloud/coucal_ASR/R_project/data/raw/coucals_first_flights_data_per_individual2020.csv", 
           header = TRUE, stringsAsFactors = FALSE, na.strings = c("", " ", "NA")) %>% 
...
saveRDS(object = parameter_distributions, 
        file = "/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/parameter_distributions.rds")
```
...
set.seed(14)
parameter_distributions <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/parameter_distributions.rds")
```
