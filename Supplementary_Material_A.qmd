...
-   For running the complete code you need a `files` subfolder containing the raw data downloaded from `Data_files` folder provided in the [GitHub](https://github.com/leberhartphillips/coucal_demography) repository.

### R packages

-   The following packages are needed for analysis and can be easily installed from [CRAN](http://cran.r-project.org/) using the following code:
...
-   demographic_rates\_: a list of all the vital rates of an iteration of the stochastic simulation run within the run_bootstrap_juv_hazd_ad_surv_ASR() function below
...
WBC_boot_out <- 
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/wrangled/WBC_adult_survival_CJS_bootstrap_tidy.rds")
```
...
saveRDS(object = parameter_distributions, 
        file = "output/parameter_distributions.rds")
```
...
```{r, echo = FALSE}
parameter_distributions <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/parameter_distributions.rds")
```
...
# load output
BC_hazard_rate_boot_tidy <-
  readRDS("/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/bootstraps/hazard/cooked/BC_haz_sur_ASR_boot_tidy_stoc_trans_no_imm.rds")

# load output
WBC_hazard_rate_boot_tidy <-
  readRDS("/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/bootstraps/hazard/cooked/WBC_haz_sur_ASR_boot_tidy_stoc_no_imm.rds")
```
...
-   vital_rate_summary: object (a list of all vital rates) produced by the make_mprime_matrix() and make_treat_matrix() functions
...
make_mprime_matrix() function makes a prime-matrix (i.e., a matrix halfway between the treatment matrix and the unbiased matrix) from a set of vital rate summaries
...
-   M_matrix_ASR:
-   scenario: male or female vital rates used as the baseline
...
```{r, echo=FALSE}
BC_treat_sensitivity_analysis <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/sensitivity_analysis/BC_treat_sensitivity_analysis_ASR.rds")

BC_Mprime_sensitivity_analysis_male <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/sensitivity_analysis/BC_Mprime_sensitivity_analysis_male_ASR.rds")

BC_Mprime_sensitivity_analysis_female <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/sensitivity_analysis/BC_Mprime_sensitivity_analysis_female_ASR.rds")

WBC_treat_sensitivity_analysis <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/sensitivity_analysis/WBC_treat_sensitivity_analysis_ASR.rds")

WBC_Mprime_sensitivity_analysis_male <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/sensitivity_analysis/WBC_Mprime_sensitivity_analysis_male_ASR.rds")

WBC_Mprime_sensitivity_analysis_female <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/sensitivity_analysis/WBC_Mprime_sensitivity_analysis_female_ASR.rds")
```
