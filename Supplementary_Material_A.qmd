...
WBC_boot_out <- 
  readRDS(file = "/Users/luketheduke2/ownCloud/coucals/final/coucal_demography/output/bootstraps/tidy/WBC_adult_survival_CJS_bootstrap_tidy.rds")
```
...
# load output
BC_hazard_rate_boot_tidy <-
  readRDS("output/bootstraps/tidy/BC_haz_sur_ASR_boot_tidy_stoc_trans.rds")#/Users/luketheduke2/ownCloud/coucals/final/R_project/output/bootstraps/tidy/BC_haz_sur_ASR_boot_tidy_stoc_trans.rds")

# load output
WBC_hazard_rate_boot_tidy <-
  readRDS("output/bootstraps/tidy/WBC_haz_sur_ASR_boot_tidy_stoc.rds")#"/Users/luketheduke2/ownCloud/coucals/final/R_project/output/bootstraps/tidy/WBC_haz_sur_ASR_boot_tidy_stoc.rds")
```
...
```{r, echo=FALSE}
BC_treat_sensitivity_analysis <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucals/final/coucal_demography/output/sensitivity_analysis/BC_treat_sensitivity_analysis_ASR_trans.rds")

BC_Mprime_sensitivity_analysis_male <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucals/final/coucal_demography/output/sensitivity_analysis/BC_Mprime_sensitivity_analysis_male_ASR_trans.rds")

BC_Mprime_sensitivity_analysis_female <-
  readRDS(file = "/Users/luketheduke2/ownCloud/coucals/final/coucal_demography/output/sensitivity_analysis/BC_Mprime_sensitivity_analysis_female_ASR_trans.rds")
