...
saveRDS(object = BC_hazard_ASR_bootstrap_result_w_trans_WBC_ad_surv_stoc, 
        file = "output/bootstraps/cooked/BC_hazard_ASR_bootstrap_result_w_trans_WBC_ad_surv_stoc.rds")

saveRDS(object = WBC_hazard_ASR_bootstrap_result_w_WBC_ad_surv_stoc, 
        file = "output/bootstraps/cooked/WBC_hazard_ASR_bootstrap_result_w_WBC_ad_surv_stoc.rds")
```
...
BC_hazard_rate_boot_tidy <- 
  hazard_boot_out_wrangle(species = "BC", niter = 1000, 
                          output_dir = "output/bootstraps/cooked/",
                          rds_file = 
...
```{r, eval=FALSE}
saveRDS(object = BC_hazard_rate_boot_tidy_trans, 
        file = 
          "output/bootstraps/cooked/BC_haz_sur_ASR_boot_tidy_stoc_trans.rds")

saveRDS(object = WBC_hazard_rate_boot_tidy, 
        file = 
          "output/bootstraps/cooked/WBC_haz_sur_ASR_boot_tidy_stoc.rds")
```
...
# load output
BC_hazard_rate_boot_tidy <-
  readRDS("/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/bootstraps/cooked/BC_haz_sur_ASR_boot_tidy_stoc_trans.rds")

# load output
WBC_hazard_rate_boot_tidy <-
  readRDS("/Users/luketheduke2/ownCloud/coucal_ASR/coucal_demography/output/bootstraps/cooked/WBC_haz_sur_ASR_boot_tidy_stoc.rds")
```
...
# load output
BC_hazard_rate_boot_tidy <-
  readRDS("/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/bootstraps/cooked/BC_haz_sur_ASR_boot_tidy_stoc_trans.rds")

# load output
WBC_hazard_rate_boot_tidy <-
  readRDS("/Users/luketheduke2/ownCloud/coucal_ASR/R_project/output/bootstraps/cooked/WBC_haz_sur_ASR_boot_tidy_stoc.rds")
```
