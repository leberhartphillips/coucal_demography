...
run_bootstrap_juv_hazd_ad_surv_ASR <- function(num_boot, offspring,
                                               k, HSR, h, egg_survival, flight_age,
                                               ISR_distribution, immigrant_pop_size, fledge_age, 
                                               bootstrap_name, adult_surival_boot_out,
                                               ...
                                               max_time = 70)
{
  ...
  result <- 
    bootstrap_juv_hazd_ad_surv_ASR(coucal_boot_list = bootstrap_data_list, 
                                   ...
                                   ISR_distribution = ISR_distribution, 
