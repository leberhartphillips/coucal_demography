...
WBC_hazard_ASR_bootstrap_result_one <-
...
# save model output
saveRDS(object = WBC_hazard_ASR_bootstrap_result_one, 
        file = "output/bootstraps/hazard/cooked/WBC_hazard_ASR_bootstrap_result_one.rds")