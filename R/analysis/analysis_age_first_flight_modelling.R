...
# "flight_age" as dependent variable, sex as independent
mod_flight_age_BC <- 
...
coucal_flight_age <- 
  data.frame(trait = c("flight_age"),
             ...
             sex = c("F", "M", "F", "M"),
             mean = c(flight_mod_coefs[1, c(2)],
                      (flight_mod_coefs[1, c(2)] + flight_mod_coefs[2, c(2)]),
                      (flight_mod_coefs[1, c(2)] + flight_mod_coefs[3, c(2)]),
                      (flight_mod_coefs[1, c(2)] + flight_mod_coefs[3, c(2)] + flight_mod_coefs[4, c(2)] + flight_mod_coefs[2, c(2)])),
             CI_low = c(flight_mod_coefs[1, c(5)],
                        (flight_mod_coefs[1, c(5)] + flight_mod_coefs[2, c(5)]),
                        (flight_mod_coefs[1, c(5)] + flight_mod_coefs[3, c(5)]),
                        (flight_mod_coefs[1, c(5)] + flight_mod_coefs[3, c(5)] + flight_mod_coefs[4, c(5)] + flight_mod_coefs[2, c(5)])),
             CI_high = c(flight_mod_coefs[1, c(6)],
                         (flight_mod_coefs[1, c(6)] + flight_mod_coefs[2, c(6)]),
                         (flight_mod_coefs[1, c(6)] + flight_mod_coefs[3, c(6)]),
                         (flight_mod_coefs[1, c(6)] + flight_mod_coefs[3, c(6)] + flight_mod_coefs[4, c(6)] + flight_mod_coefs[2, c(6)])),
             n_inds = c(filter(flight_dat, Spp == "BC" & Sex == "Female") %>% 
...
#              species = c("BC", "BC", "WBC", "WBC"),
#              sex = c("F", "M", "F", "M"),
#              mean = c(flight_mod_coefs[1, c(2)] + pull(filter(coucal_flight_age, species == "BC" & sex == "F"), mean),
#                       (flight_mod_coefs[1, c(2)] + flight_mod_coefs[2, c(2)] + pull(filter(coucal_flight_age, species == "BC" & sex == "M"), mean)),
#                       (flight_mod_coefs[1, c(2)] + flight_mod_coefs[3, c(2)] + pull(filter(coucal_flight_age, species == "WBC" & sex == "F"), mean)),
#                       (flight_mod_coefs[1, c(2)] + flight_mod_coefs[3, c(2)] + flight_mod_coefs[4, c(2)] + flight_mod_coefs[2, c(2)]) + pull(filter(coucal_flight_age, species == "WBC" & sex == "M"), mean)),
#              CI_low = c(flight_mod_coefs[1, c(5)] + pull(filter(coucal_flight_age, species == "BC" & sex == "F"), mean),
#                         (flight_mod_coefs[1, c(5)] + flight_mod_coefs[2, c(5)]) + pull(filter(coucal_flight_age, species == "BC" & sex == "M"), mean),
#                         (flight_mod_coefs[1, c(5)] + flight_mod_coefs[3, c(5)]) + pull(filter(coucal_flight_age, species == "WBC" & sex == "F"), mean),
#                         (flight_mod_coefs[1, c(5)] + flight_mod_coefs[3, c(5)] + flight_mod_coefs[4, c(5)] + flight_mod_coefs[2, c(5)]) + pull(filter(coucal_flight_age, species == "WBC" & sex == "M"), mean)),
#              CI_high = c(flight_mod_coefs[1, c(6)] + pull(filter(coucal_flight_age, species == "BC" & sex == "F"), mean),
#                          (flight_mod_coefs[1, c(6)] + flight_mod_coefs[2, c(6)]) + pull(filter(coucal_flight_age, species == "BC" & sex == "M"), mean),
#                          (flight_mod_coefs[1, c(6)] + flight_mod_coefs[3, c(6)]) + pull(filter(coucal_flight_age, species == "WBC" & sex == "F"), mean),
#                          (flight_mod_coefs[1, c(6)] + flight_mod_coefs[3, c(6)] + flight_mod_coefs[4, c(6)] + flight_mod_coefs[2, c(6)]) + pull(filter(coucal_flight_age, species == "WBC" & sex == "M"), mean)),
#              n_inds = c(filter(flight_dat, Spp == "BC" & Sex == "Female") %>%
#                           summarise(n_ = n_distinct(Ind_ID)) %>%
#                           pull(n_),
#                         filter(flight_dat, Spp == "BC" & Sex == "Male") %>%
...
rm(flight_dat, flight_mod, flight_mod_coefs)
