...
BC_survival_ASR_bootstrap_result_four <-
  pbsapply(1:niter, run_bootstrap_survival_ASR,
           ...
           flight_age = 36,
           first_year = 2001,
           bootstrap_name = "BC_boot_four",
           species = "BC",
           iter_add = 4,
           prefix_number = "boot_four_")

save(BC_survival_ASR_bootstrap_result_four,
     file = "output/bootstraps/BC_survival_ASR_bootstrap_result_four.rds")