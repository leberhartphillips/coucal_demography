...
BC_survival_ASR_bootstrap_result_three <-
  pbsapply(1:niter, run_bootstrap_survival_ASR,
           ...
           flight_age = 36,
           first_year = 2001,
           bootstrap_name = "BC_boot_three",
           species = "BC",
           iter_add = 3,
           prefix_number = "boot_three_")

save(BC_survival_ASR_bootstrap_result_three,
     file = "output/bootstraps/BC_survival_ASR_bootstrap_result_three.rds")